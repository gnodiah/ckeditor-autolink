		...
		init: function( editor ) {
			...
			editor.addCommand( 'maximize', {
				...
				exec: function() {
					...
					var noResetClass = typeof(editor.config.maximizeResetClass) === 'boolean' ? !editor.config.maximizeResetClass : false;
					...
					if ( this.state == CKEDITOR.TRISTATE_OFF ) {
						...
						while ( ( currentNode = currentNode.getParent() ) ) {
							currentNode.setCustomData( 'maximize_saved_styles', saveStyles( currentNode, noResetClass ) );
